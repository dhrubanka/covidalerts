                                    ...
                                    <ul class="card-ul-list" style="list-style-type: none; padding: 10px;">
                                        <li class="card-list"><span>
                                                <select class="form-select" aria-label="Default select example"
                                                    ...
                                                    <option value="https://telegram.me/kamrupmetroCA18">Kamrup
                                                        Metropolitan</option>
                                                    ...
                                                    <option value="https://telegram.me/kamrupruralCA18">Kamrup Rural
                                                    </option>
                                                    <option value="https://telegram.me/joinchat/OoiD68jRRFRlNzFl">
                                                        Lakhimpur</option>
                                                    <option value="https://telegram.me/joinchat/b6MR0phezg1mMjI1">
                                                        Tinsukia</option>
                                                    <option value="https://telegram.me/joinchat/kz7X17M6-jJhZDc1">
                                                        Golaghat</option>
                                                    <option value="https://telegram.me/joinchat/IX4JwRFMcEhjYTBl">Majuli
                                                    </option>
                                                    ...
                                                    <option value="https://telegram.me/joinchat/HPf5iO88t_83YmI1">
                                                        Udalguri</option>
                                                    <option value="https://telegram.me/joinchat/obpgn4hLIyg4ZGM1">Cachar
                                                    </option>
                                                    <option value="https://telegram.me/joinchat/fEQ_S3r81TZjZDQ9">
                                                        Chirang</option>
                                                    <option value="https://telegram.me/joinchat/H8MczgjAlylkMTFl">
                                                        Biswanath</option>
                                                    <option value="https://telegram.me/joinchat/r4GJ3ZhSfhNjNDg9">Baksa
                                                    </option>
                                                </select>
                                            </span></li>
                                    </ul>
                                    <div class="card-button">
                                        <a id="underButton" href="#"
                                            class="btn btn-sm border btn-flash-border-primary">OPEN LINK</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="card-body pt-0">
                                        <div class="card-body-widget">
                                            ...
                                            <ul class="card-ul-list" style="list-style-type: none; padding: 10px;">
                                                <li class="card-list"><span>
                                                        <select class="form-select" aria-label="Default select example"
                                                            onchange="setAboveLink(this.value)">
                                                            <option selected value="">Select your district</option>
